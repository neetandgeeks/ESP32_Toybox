...
/*
    3axis_v4.h
    3axis_Arduino_CNC_Shield_grbl_08.h

    Pin assignments for the ESP32 Development Controller, v4.1 and later.
    https://github.com/bdring/Grbl_ESP32_Development_Controller
    https://www.tindie.com/products/33366583/grbl_esp32-cnc-development-board-v35/

    for "Arduino CNC Shield v3.0 (Grbl 0.8x)" with "waves ESP32 ESPDuino-32"
...
#define Z_LIMIT_PIN             GPIO_NUM_23  // D11 of the CNC Shield
...
#define SPINDLE_OUTPUT_PIN      GPIO_NUM_18  // labeled SpinPWM,  D13
#define SPINDLE_ENABLE_PIN      GPIO_NUM_19  // labeled SpinEnbl, D12

//#define COOLANT_MIST_PIN        GPIO_NUM_34  // labeled Mist,  A3
#define COOLANT_FLOOD_PIN       GPIO_NUM_34  // labeled Flood, A3
#define PROBE_PIN               GPIO_NUM_39  // labeled Probe, A5
